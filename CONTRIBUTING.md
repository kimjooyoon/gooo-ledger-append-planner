...
The independent verifier under `cmd/gooo-ledger-append-verifier` must remain a separate consumer: it may not import `internal/planner`. It checks the authority boundary and materialized output independently in GitHub Actions.
